...
export function Footer() {
  return (
    <footer className="relative -mt-px" aria-label="Site footer">
      <div className="mx-auto flex max-w-5xl flex-col gap-px border border-b-0 border-line bg-line">
        <div className="rounded-2xl bg-background px-gutter pt-12 pb-8">
        ...
        <div className="rounded-t-2xl bg-background px-gutter pt-8 pb-12">
